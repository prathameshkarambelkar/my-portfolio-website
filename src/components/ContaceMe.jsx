      ...
      >
        ...
        <div>
          ...
          <div className=" border-2 border-white  flex  rounded-full p-1 m-2 justify-center items-center">
            <a href="https://twitter.com/PrathameshK_69" target="_blank" rel="noopener noreferrer">
              <svg
            ...
            <a href="https://github.com/prathameshkarambelkar" className="" target="_blank" rel="noopener noreferrer">
               <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            <a href="https://www.linkedin.com/in/prathamesh-karambelkar-1161b71aa/" target="_blank" rel="noopener noreferrer">
               <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
