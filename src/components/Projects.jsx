...
export const Projects = () => {
  return (
    <>
      <section
        id="Projects"
        className="md:grid md:grid-cols-3 lg:flex-row sm:flex p-2  sm:flex-col sm:items-center sm:justify-center  sm:m-auto min-h-screen  bg-fixed bg-center bg-cover md:bg-[url('/Projects.png')]  bg-[url('/ProjectsSmall.png')] "
      >
        <Project
