...
const Talks = () => {
  return (
    <>
      <section
        id="Talks"
        className=" flex flex-col min-h-screen justify-center items-center   bg-fixed bg-center bg-cover bg-[url('/TalksSmall.png')] lg:bg-[url('/Talks.png')] md:bg-[url('/Talks.png')] "
      >
        <Talk
